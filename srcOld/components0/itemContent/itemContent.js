...
import ItemContentShipping from '../itemContentShipping/itemContentShipping'
import ItemContentAttributes from '../itemContentAttributes/itemContentAttributes'
...
const ItemContent = ({ strings, username, item, onChangedSelect, addToCart, shareFacebook, shareWhatsapp }) => {
  ...
  return (
    <div className="item-content">
      ...
      <div className="item-content__addToCart">
      ...
      <div className="item-content__share">
