...
const CheckoutView = ({strings, cart, placeOrder}) => {
...
{/****************************** END BILLING INFORMATION *****************************/}
      ...
      <div className="col s12 m12 l5 checkout-view__summary">
        ...
        <div className="checkout-view__summary__title">
          <div className="col s12">
            {strings.labelCartSummary}
          </div>
        </div>

        <div className="checkout-view__summary__line">
        ...
        <div className="checkout-view__summary__line-total">
          <div className="col s8">
