 ...
 * @property {Object[]} newProduct.variations - variations of product.
 * @property {string[]} newProduct.pictures - pictures of product.
 * @param {updateProduct~callback} callback - The callback that handles the response.
 */
export const updateProduct = ( userId, storeId, productId, newProductData, callback ) => {
  put( 'products/'+productId+'?userid='+userId+'&storeid='+storeId, { newProductData }, callback )
}
/**
 * @callback updateProduct~callback
 * @param {Object} result - products list array
 * @property {?number} result.error - show any error in the response or show null value
 */
/******************************************************************************/
