...
export const jordiInit = () => {
  // ------------------------------------------ Toggle chatbot -----------------------------------------------
  $('.jordi .profile_div').click(function() {
  	$('.jordi .profile_div').toggle();
  	$('.jordi .chatCont').toggle();
  	$('.jordi .bot_profile').toggle();
  	$('.jordi .chatForm').toggle();
  	document.getElementById('chat-input').focus();
  });

  $('.jordi .close').click(function() {
  	$('.jordi .profile_div').toggle();
  	$('.jordi .chatCont').toggle();
  	$('.jordi .bot_profile').toggle();
  	$('.jordi .chatForm').toggle();
  ...
  //------------------------------------------- Send request to actions ---------------------------------------
  const actionResponse = (text, action=null, callback) => {
    callback({ speech:'holaaaaa' })
  }

  function sendToActions(text) {
    actionResponse(text, (response) => {
      setBotResponse(response.speech)
      if(response.suggestions) { // check if quick replies are there in api.ai
        addSuggestion(response.suggestions)
      }
    })
  }
