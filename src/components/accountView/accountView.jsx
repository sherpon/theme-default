...
import style from './accountView.scss'

const _strings = {
  ES:require('./strings/accountView.ES.json'),
  EN:require('./strings/accountView.EN.json')
}

const AccountView = ({language, user, updateAccount, updatePassword}) => {
  ...
  return (
    <div className="account-view row">
      ...
      <div className="col s12 m12 l6">
        <div className="account-view__information row">
